...
class WechatPay
{
    ...
    public static function instance()
    {
        if (static::$instance == null) {
            $instance = new static();
            $config = \App::$config['site_info']['wechat'];
            $keyList = [
    ...
    public function createPreOrder($title, $out_trade_no, $money, $type = null)
    {
        ...
        $notify_url = $this->config['notify'];//回调的url;
    ...
    public function notify($xml)
    {
        ...
        $sign = $res['sign'];
        $newSign = $this->sign($res, $this->config['pay_key']);
        if ($sign != $newSign) {
    ...
    public function refund($order)
    {
        ...
        $data = [
            ...
            'out_refund_no' => str_replace('BO', 'TK', $order['order_code']),
