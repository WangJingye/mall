            ...
            <tr>
                ...
                <td>
                    <a class="btn btn-outline-primary btn-sm"
                       href="<?= \App::$urlManager->createUrl('system/role/edit-role', ['id' => $v['id']]) ?>">
                        <i class="glyphicon glyphicon-pencil"></i> 编辑
                    </a>
                    <a class="btn btn-outline-primary btn-sm"
                       href="<?= \App::$urlManager->createUrl('system/role/set-role-menu', ['id' => $v['id']]) ?>">
                        <i class="glyphicon glyphicon-align-justify"></i> 设置角色权限
                    </a>
                    <a class="btn btn-outline-primary btn-sm"
                       href="<?= \App::$urlManager->createUrl('system/role/set-role-admin', ['id' => $v['id']]) ?>">
