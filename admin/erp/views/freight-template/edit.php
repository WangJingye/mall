<form class="form-box col-12 col-sm-8 col-md-6" id="save-form"
    ...
    <div class="form-group row">
        <label class="col-sm-4 text-nowrap col-form-label form-label"><span style="color: red">*</span>模版名称</label>
        <div class="col-sm-8">
    ...
    <div class="form-group row">
        <label class="col-sm-4 text-nowrap col-form-label form-label"><span style="color: red">*</span>计价方式</label>
        <div class="col-sm-8">
    ...
    <div class="form-group row">
        <label class="col-sm-4 text-nowrap col-form-label form-label"><span style="color: red">*</span>起步数量</label>
        <div class="col-sm-8">
    ...
    <div class="form-group row">
        <label class="col-sm-4 text-nowrap col-form-label form-label"><span style="color: red">*</span>起步价</label>
        <div class="col-sm-8">
    ...
    <div class="form-group row">
        <label class="col-sm-4 text-nowrap col-form-label form-label"><span style="color: red">*</span>增加数量</label>
        <div class="col-sm-8">
    ...
    <div class="form-group row">
        <label class="col-sm-4 text-nowrap col-form-label form-label"><span style="color: red">*</span>增加费用</label>
        <div class="col-sm-8">
