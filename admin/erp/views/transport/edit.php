<form class="form-box col-12 col-sm-8 col-md-6" id="save-form"
      action="<?= \App::$urlManager->createUrl('erp/transport/edit') ?>" method="post">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <input type="text" name="transport_name" class="form-control" value="<?= $this->model['transport_name'] ?>"
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <input type="text" name="remark" class="form-control" value="<?= $this->model['remark'] ?>"
                   placeholder="请输入备注">
        </div>
    </div>
    <div class="form-group row">
