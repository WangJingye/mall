<form class="form-box col-12 col-sm-8 col-md-6" id="save-form"
    ...
    <div class="form-group row">
        <label class="col-sm-4 text-nowrap col-form-label form-label">昵称</label>
        <div class="col-sm-8">
    ...
    <div class="form-group row">
        <label class="col-sm-4 text-nowrap col-form-label form-label">姓名</label>
        <div class="col-sm-8">
    ...
    <div class="form-group row">
        <label class="col-sm-4 text-nowrap col-form-label form-label">城市</label>
        <div class="col-sm-8">
    ...
    <div class="form-group row">
        <label class="col-sm-4 text-nowrap col-form-label form-label">生日</label>
        <div class="col-sm-8">
