<form class="form-box col-12 col-sm-10 col-md-10" id="save-form"
    ...
    <div class="form-group row">
        <label class="col-sm-2 text-nowrap col-form-label form-label"><span style="color: red">*</span>优惠券标题</label>
        <div class="col-sm-10">
    ...
    <div class="form-group row">
        <label class="col-sm-2 text-nowrap col-form-label form-label"><span style="color: red">*</span>优惠券类型</label>
        <div class="col-sm-10">
    ...
    <div class="form-group row type-list type-2" <?= $this->model['type'] == 2 ? '' : 'style="display: none"' ?>>
        <label class="col-sm-2 text-nowrap col-form-label form-label">商品分类</label>
        <div class="col-sm-10">
    ...
    <div class="form-group row type-list type-3" <?= $this->model['type'] == 3 ? '' : 'style="display: none"' ?>>
        <label class="col-sm-2 text-nowrap col-form-label form-label">商品</label>
        <div class="col-sm-10">
    ...
    <div class="form-group row">
        <label class="col-sm-2 text-nowrap col-form-label form-label"><span style="color: red">*</span>面值</label>
        <div class="col-sm-10">
    ...
    <div class="form-group row">
        <label class="col-sm-2 text-nowrap col-form-label form-label"><span style="color: red">*</span>所需积分</label>
        <div class="col-sm-10">
    ...
    <div class="form-group row">
        <label class="col-sm-2 text-nowrap col-form-label form-label"><span style="color: red">*</span>最小使用价格</label>
        <div class="col-sm-10">
    ...
    <div class="form-group row">
        <label class="col-sm-2 text-nowrap col-form-label form-label"><span style="color: red">*</span>有效期</label>
        <div class="col-sm-10">
    ...
    <div class="form-group row">
        <label class="col-sm-2 text-nowrap col-form-label form-label">详情</label>
        <div class="col-sm-10">
            <textarea name="detail" class="form-control kindeditor"
                      placeholder="请输入优惠券详情"><?= $this->model['detail'] ?></textarea>
        </div>
    </div>
    <div class="form-group row">
