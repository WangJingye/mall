    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <div style="margin-bottom:1rem">订单超过 <input type="number" name="expire_order_pay" class="form-control"
                                                        placeholder="输入整数"
                                                        value="<?= $this->model['expire_order_pay'] ?>"
                                                        style="width: 4.5rem;display: inline"> 分钟未付款，订单自动取消
            </div>
            <div style="margin-bottom:1rem">订单超过 <input type="number" name="expire_order_pending" class="form-control"
                                                        placeholder="输入整数"
                                                        value="<?= $this->model['expire_order_pending'] ?>"
                                                        style="width: 4.5rem;display: inline"> 分钟未成团，订单自动取消
            </div>
            <div style="margin-bottom:1rem">订单发货超过 <input type="number" name="expire_order_finish" class="form-control"
                                                          placeholder="输入整数"
                                                          value="<?= $this->model['expire_order_finish'] ?>"
                                                          style="width: 4.5rem;display: inline"> 天，自动确认收货
            </div>
            <div style="margin-bottom:1rem">订单完成 <input type="number" name="expire_order_comment" class="form-control"
                                                        placeholder="输入整数"
                                                        value="<?= $this->model['expire_order_comment'] ?>"
