<form class="form-box col-12 col-sm-8 col-md-6" id="save-form"
      action="<?= \App::$urlManager->createUrl('erp/site-info/base-info') ?>" method="post">
    <div class="form-group row">
        <label class="col-sm-4 text-nowrap col-form-label form-label">管理后台名称</label>
        <div class="col-sm-8">
            <input type="text" name="web_name" class="form-control" value="<?= $this->model['web_name'] ?>"
                   placeholder="管理后台名称">
        </div>
    </div>
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <input type="text" name="web_host" class="form-control" value="<?= $this->model['web_host'] ?>"
                   placeholder="请输入网站域名">
        </div>
    </div>
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <input type="text" name="web_ip" class="form-control" value="<?= $this->model['web_ip'] ?>"
                   placeholder="请输入网站IP">
        </div>
    </div>
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <input type="password" name="default_password" class="form-control"
                   value="<?= $this->model['default_password'] ?>"
