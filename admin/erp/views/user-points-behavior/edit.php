<form class="form-box col-12 col-sm-8 col-md-6" id="save-form" action="<?= \App::$urlManager->createUrl('erp/user-points-behavior/edit') ?>" method="post">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <input type="text" name="behavior_name" class="form-control" value="<?= $this->model['behavior_name']?>" placeholder="请输入行为名称">
        </div>
    </div>
    <div class="form-group row">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <input type="text" name="points" class="form-control" value="<?= $this->model['points']?>" placeholder="请输入积分">
        </div>
    </div>
    <div class="form-group row">
        <label class="col-sm-4 text-nowrap col-form-label form-label">次数</label>
        <div class="col-sm-8">
            <input type="text" name="number" class="form-control" value="<?= $this->model['number']?>" placeholder="请输入次数">
        </div>
    </div>
    <div class="form-group row">
