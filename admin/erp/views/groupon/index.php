<div class="btn-box clearfix">
    <a href="<?= \App::$urlManager->createUrl('erp/groupon/edit') ?>">
...
<form class="search-form" action="<?= \App::$urlManager->createUrl('erp/groupon/index') ?>" method="get">
    ...
    <div class="form-content">
        <?= \admin\extend\input\TimeSearch::instance('create_time', '创建时间', $this->params)->show() ?>
    </div>
            ...
            <tr>
                ...
                <td>
                    <a class="btn btn-primary btn-sm"
                       href="<?= \App::$urlManager->createUrl('erp/groupon/edit', ['id' => $v['id']]) ?>">
