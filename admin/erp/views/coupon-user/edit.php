<form class="form-box col-12 col-sm-8 col-md-6" id="save-form" action="<?= \App::$urlManager->createUrl('erp/coupon-user/edit') ?>" method="post">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            ...
            <input type="text" class="form-control search-user" readonly value="<?= $this->user['nickname']?>" placeholder="点击选择用户" style="display: inline">
        </div>
    </div>
    <div class="form-group row">
