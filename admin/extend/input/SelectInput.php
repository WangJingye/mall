        ...
        if (in_array($this->type, ['radio', 'checkbox'])) {
            ...
            foreach ($this->list as $k => $v) {
                ...
                $html .= '<div class="custom-control custom-' . $this->type . ' custom-control-inline">' .
                    '<input class="custom-control-input" type="' . $this->type . '"' . ($this->name ? ' name="' . $this->name . '"' : '') . ' id="' . $this->name . $k . '"' .
            ...
            $html = '<select' . ($this->name ? ' name="' . $this->name . '"' : '') . ' class="form-control ' . $this->type . '" ' . ($this->multi ? 'multiple' : '') . '>';
            if (!$this->multi) {
